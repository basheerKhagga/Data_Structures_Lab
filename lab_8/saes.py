...
class SimplifiedAES(object):
    ...
    def key_expansion(self, key):
        ...
        # print(self.int_to_state((w[0] << 8) + w[1]))
        # print(self.int_to_state((w[2] << 8) + w[3]))
        # print(self.int_to_state((w[4] << 8) + w[5]))
        return (
    ...
    def encrypt(self, plaintext):
        ...
        """
        print("first method in encryption")
        print(self.int_to_state(plaintext))
